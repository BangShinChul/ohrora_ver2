<content id="content">	
	<div id="container" class="container-fixed" style="text-align: center;">
		...
		<form action="/index.php/main/get_login" method="post">
		...
		<input class="btn" type="button" name="getAccount" value="Sign Up" onClick="location.href = '/index.php/main/get_account'"/>
	</div>
